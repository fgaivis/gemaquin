...
<header><h3><?php  __('Organization');?></h3></header>
...
<div class="actions">
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete Organization', true), array('action' => 'delete', $organization['Organization']['id'])); ?> </li>
...
<div class="related">
	...
	<?php
		$i = 0;
		foreach ($organization['BankAccount'] as $bankAccount):
			$class = null;
			if ($i++ % 2 == 0) {
				$class = ' class="altrow"';
			}
